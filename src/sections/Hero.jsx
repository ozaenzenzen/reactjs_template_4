  ...
  return (
    ...
    >
      ...
      <div className="lg:w-3/5 w-full flex flex-col justify-center items-start gap-8">
        <h1 data-aos="zoom-in"  className="text-themered lg:text-3xl text-xl font-semibold">
          Hi, I'm Fauzan Akmal Mahdi
        </h1>
        <h1 data-aos="zoom-in" data-aos-delay="200"  className="text-white text-5xl font-semibold font-poppins">
        ...
        <button data-aos="zoom-in" data-aos-delay="600" className="bg-themered hover:bg-white text-white hover:text-themered font-semibold text-lg px-8 py-3 rounded-lg mt-5 font-poppins">
          Contact Me
        </button>
      </div>
